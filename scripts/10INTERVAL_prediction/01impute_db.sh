...
--model_db_path ${db} \
--prediction_output /home/rschubert1/scratch/TOPMed_Proteome/10INTERVAL_prediction/valid_models/${db:74:(-3)}_predicted_expression.txt \
--prediction_summary_output /home/rschubert1/scratch/TOPMed_Proteome/10INTERVAL_prediction/valid_models/${db:74:(-3)}_summary.txt
