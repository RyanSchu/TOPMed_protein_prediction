...
saveRDS(pruned,"/home/ryan/topmed/proteome/" %&% args[1] %&%  "/PCAIR/pruned_set.RDS")
...
# 
# king<-readRDS("/home/ryan/topmed/proteome/ALL/unrelated_ALL/PCair_steps/King_matrix.RDS")
# 
# kingMat<-king$kinship
