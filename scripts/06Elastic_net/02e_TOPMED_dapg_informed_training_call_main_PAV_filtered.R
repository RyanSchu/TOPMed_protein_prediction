...
snp_annot_file <- "/data/rschubert1/TOPMED_Proteome/" %&% pop %&% "/PCAIR_modeling/01genotypes/preddb_input_PAV_filtered/uniq_pred_db_hg38.chr" %&% chrom %&% ".maf0.01.R20.8.anno.txt.gz"
gene_annot_file <- "/data/rschubert1/TOPMED_Proteome/annotation_all_aptamers_ENSG.txt"
genotype_file <- "/data/rschubert1/TOPMED_Proteome/" %&% pop %&% "/PCAIR_modeling/01genotypes/preddb_input_PAV_filtered/uniq_pred_db_hg38.chr" %&% chrom %&% ".maf0.01.R20.8.geno.txt.gz"
...
prefix <- "/home/rschubert1/data/TOPMED_Proteome/" %&% pop %&% "/PCAIR_modeling/06Elastic_net/dapg_" %&% pip %&% "_" %&% suffix %&% "_PAV_filtered_out/" %&% pop %&% "_chr" %&% chrom %&% "_" %&% "PIP_" %&% pip %&% "_clus_filt_" %&% suffix
